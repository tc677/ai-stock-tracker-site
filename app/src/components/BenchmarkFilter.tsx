...
export function BenchmarkFilter({
  ...
  return (
    <div className="flex flex-nowrap items-center gap-2 text-sm overflow-x-auto pb-1">
      <span className="text-xs text-zinc-500 mr-1 flex-shrink-0">
        Compare to:
      </span>
      {benchmarks.map((b) => {
        ...
        return (
          <button
            ...
            className={`flex-shrink-0 whitespace-nowrap px-3 py-1 rounded-full border text-xs font-medium transition-colors ${
              on
